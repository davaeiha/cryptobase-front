                ...
                <div className="flex justify-evenly w-full md:max-w-[300px] uppercase">
                    <div>
                        ...
                        <ul>
                            ...
                            <li className=" text-sm py-2">Documention</li>
                ...
                <div className="text-right">
                    <div className=" w-full flex justify-end">
                        <div className=" w-full md:w-[300px] py-4 relative">
                            ...
                            <div className=" py-4">
                                <form>
                                    <input className=" bg-primary border-input p-2 w-full shadow-xl rounded-2xl " type="email" placeholder="Enter your Email"/>
                                    <button className=" bg-button text-btnText px-4 p-2 w-full rounded-2xl shadow-xl hover:shadow-2xl my-2">Sign Up</button>
                                </form>
                            </div>
